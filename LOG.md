...
- [x] Узлы AST: `NumberLit`, `IdentExpr`, `BinaryExpr`, `UnaryExpr`, `FuncCallExpr`
...
### [2026-04-22] Фаза 8 — Таблицы
**Статус:** удалено (отложено в v2)

Синтаксис `table { }`, `->`, `TableExpr`, `StringLitExpr`, `mc_interp` и связанные тесты удалены — таблицы не входят в MVP. Синтаксис из спеки (`["key": value]`) будет реализован в v2.
