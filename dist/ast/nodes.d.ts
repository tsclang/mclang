...
export type Expr = NumberLit | BoolLit | IdentExpr | BinaryExpr | UnaryExpr | FuncCallExpr | QualifiedCallExpr | IfExpr | IndexExpr | SliceExpr | MatrixSlice | MemberExpr | ArrayLit | MatrixLit | FracExpr | SqrtExpr | AbsExpr | NormExpr | FloorExpr | CeilExpr | PmExpr | CasesExpr | SumExpr | PostfixExpr | ChainCmpExpr | LimExpr | DerivExpr | IntegralExpr | SolveExpr | TableExpr | StringLitExpr;
...
export type NormExpr = {
    kind: 'NormExpr';
    operand: Expr;
    span: Span;
};
export type FloorExpr = {
    kind: 'FloorExpr';
    operand: Expr;
    span: Span;
};
export type CeilExpr = {
    kind: 'CeilExpr';
    operand: Expr;
    span: Span;
};
